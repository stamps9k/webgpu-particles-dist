...
import { ScatterFadeEffect } from "../../public/effects/ScatterFadeEffect";
import { EmitterConfig } from "../../public/EmitterConfig";
export declare class ScatterFadeRenderer implements EffectRenderer {
    ...
    constructor(effect: ScatterFadeEffect);
    static initialize(effect: ScatterFadeEffect): ScatterFadeRenderer;
